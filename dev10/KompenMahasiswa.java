...
public class KompenMahasiswa {
    public static void main(String[] args) {
        ...
        for (int i = 1; i < alpa.length; i++) {
            totalAlpa += alpa[i];
            kompen[i] = alpa[i] * (int) Math.pow(2, alpa.length - i);
                ...
                switch (mhsChoice) {
                    ...
                    case 5: // Peraturan Sistem Kompen Mahasiswa
                        ...
                        while (true) {
                            ...
                            System.out.println("4. Kompensasi dilaksanakan setelah jam pelajaran resmi berakhir atau apa saat liburan. Bilamana kompensasi tidak dilaksanakan pada semester yang sama maka jumlah kompensasi dikalikan dua pada semester berikutnya dan demikian seterusnya. ");
                            System.out.println("0. Kembali");
                            System.out.println("1. Keluar");
                            System.out.print("Masukkan pilihan anda: ");
