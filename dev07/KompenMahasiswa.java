        ...
        while (loggedInAdmin) {
            ...
            while(loggedInMahasiswa){
                ...
                switch (mhsChoice) {
                    ...
                    case 2: //alpaku
                        int[] alpa = {3, 1, 8, 2, 3};
                        int[] kompen = {10, 8, 6, 4, 2};
                        String[] semester = {"Semester 1", "Semester 2", "Semester 3", "Semester 4", "Semester 5"};
                        ...
                        while (true) {
                            ...
                            switch (subChoice2) {
                                ...
                                case 5: // Semester 5
                                    ...
                                    System.out.println("Total jam tugas kompen " + semester[i] + ": " + alpa[i] * kompen[i] + " jam");
                                    System.out.println("0. Kembali");
                                    System.out.println("1. Keluar");
                                    System.out.print("Masukkan pilihan Anda: ");
